...
- Your Pokémon shouldn't disappear on Fabric anymore tho the Shadow type icon will appear as normal _(a temporary workaround is to join a singleplayer world first and then the server)_
- These were _mostly_ fixed by Mega Showdown Lost Lore requires **at least** 1.7.0 of MSD
...
## Updated & Rebalanced many Pokémon:
...
- Gave it a _stupid_ hidden ability - let's just call it an easter egg!
